...
4. **Start the Backend Server:**
   ...
   _Alternatively, if configured in your package.json, you can run:_
...
4.  **Start the Frontend Server:**
    ...
    _The application should now be running locally. Check your terminal for the localhost port (usually `http://localhost:5173`)._
